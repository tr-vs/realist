...
const Magnify = ({onClick}) => {
    return (
        <svg className='search-image' width='30' height='30' version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"  fill="#000000" transform="rotate(270)" onClick={onClick}>
